...
public:
	...
	double get_consumption_per_sec(int speed)
	{
		...
		else if (speed > 140)consumption_per_sec = CONSUMPTION * 3e-5 * 8.333;
		else if (speed > 100)consumption_per_sec = CONSUMPTION * 3e-5 * 6.666;
		else if (speed > 60)consumption_per_sec = CONSUMPTION * 3e-5 * 4.6;
		else if (speed > 0)consumption_per_sec = CONSUMPTION * 3e-5 * 6.666;
